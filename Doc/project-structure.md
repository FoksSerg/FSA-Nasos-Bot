...
├── 🖥️ MikrotikUploader/                # GUI управление RouterOS
│   ├── mikrotik_uploader.py             # Основное GUI приложение v2.0
│   ├── README.md                        # Документация GUI
│   ├── requirements_gui.txt             # Зависимости GUI (не требуются)
│   └── requirements_uploader.txt        # Зависимости загрузчика
...
#### MikrotikUploader/
**Назначение:** Профессиональное GUI для управления RouterOS v2.0
- 🖥️ Полное управление роутерами MikroTik через API
- 🗑️ Удаление скриптов и шедулеров с решением проблем API
- 🏃 Управление активными задачами (jobs)
- ⚡ Smart Reconnect технология для свежих данных
- 📊 Прогрессивное ожидание вместо статичных задержек
- 🔧 Решение критических проблем RouterOS API:
  - ✅ Пагинация - все скрипты видны (15+ вместо 11)
  - ✅ Большие скрипты - удаление без timeout'ов
  - ✅ Устаревшие соединения - автообновление
- 📱 Современный интерфейс с табличным отображением
