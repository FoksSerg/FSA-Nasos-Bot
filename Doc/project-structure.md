...
- 📥 Входные данные: `InputSeconds` (количество секунд)
- 📤 Выходные данные: `FormattedLog` (обычный текст), `FormattedTelegram` (URL-кодированный)
- 🕐 Поддержка секунд, минут, часов и минут
